...
INSERT INTO `sanatorio`.`users` (`USER_ID`, `PASSWORD`, `STATE`, `USER_NAME`, `VERSION`,`CREATION_DATE`, `PROFILE_ID`,`EMAIL`) VALUES ('3', '10c4981bb793e1698a83aea43030a388', 'ACTIVE', 'admin.admin', '1', sysdate(),'1','passrecover2017@gmail.com');
