...
CREATE TABLE MENU_OPTIONS (MENU_ID BIGINT NOT NULL, URL VARCHAR(50), ACTIVE TINYINT(1) default 0 NOT NULL, CREATION_DATE DATETIME, IS_PARENT TINYINT(1) default 0 NOT NULL, KEY_ VARCHAR(50) NOT NULL, LAST_UPDATE DATETIME, REDIRECT TINYINT(1) default 0 NOT NULL, VERSION BIGINT, PARENT_ID BIGINT, PRIMARY KEY (MENU_ID))
