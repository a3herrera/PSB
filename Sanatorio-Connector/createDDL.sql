CREATE TABLE PERSONS (PERSON_ID BIGINT NOT NULL, BIRTHDAY DATETIME, FIRTS_NAME VARCHAR(20) NOT NULL, GENDER VARCHAR(20), SECOND_NAME VARCHAR(20), SECOND_SURNAME VARCHAR(20), SURNAME VARCHAR(20), VERSION BIGINT, PRIMARY KEY (PERSON_ID))
CREATE TABLE PERSON_INFORMATION (INFORMATION_ID BIGINT NOT NULL, TYPE VARCHAR(30) NOT NULL, VERSION BIGINT, PERSON_ID BIGINT NOT NULL, PRIMARY KEY (INFORMATION_ID))
CREATE TABLE PROFILES (PROFILE_ID BIGINT NOT NULL, NAME VARCHAR(30) NOT NULL, STATE TINYINT(1) default 0 NOT NULL, VERSION BIGINT, PRIMARY KEY (PROFILE_ID))
CREATE TABLE USERS (USER_ID BIGINT NOT NULL, PASSWORD VARCHAR(150) NOT NULL, STATE VARCHAR(255) NOT NULL, USER_NAME VARCHAR(50) NOT NULL, VERSION BIGINT, PROFILE_ID BIGINT, PERSON_ID BIGINT NOT NULL, PRIMARY KEY (USER_ID))
